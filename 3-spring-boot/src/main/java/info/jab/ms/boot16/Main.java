...
class WebAppInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
	...
	public void initialize(GenericApplicationContext context) {
		...
		context.registerBean(WebServerFactoryCustomizerBeanPostProcessor.class, this::webServerFactoryCustomizerBeanPostProcessor);
		context.registerBean(TomcatServletWebServerFactory.class, this::tomcatServletWebServerFactory);
		...
		context.registerBean(RequestMappingHandlerMapping.class,
				() -> requestMappingHandlerMapping(context.getBean(ContentNegotiationManager.class)));
		context.registerBean(PathMatcher.class, this::mvcPathMatcher);
		context.registerBean(UrlPathHelper.class, this::mvcUrlPathHelper);
		context.registerBean(ContentNegotiationManager.class, this::mvcContentNegotiationManager);
		context.registerBean(RequestMappingHandlerAdapter.class,
				() -> requestMappingHandlerAdapter(context.getBean(ContentNegotiationManager.class)));
		context.registerBean(FormattingConversionService.class, this::mvcConversionService);
	...
	public RequestMappingHandlerAdapter requestMappingHandlerAdapter(ContentNegotiationManager mvcContentNegotiationManager) {
	...
	public Validator mvcValidator() {
		...
		if (ClassUtils.isPresent("javax.validation.Validator", getClass().getClassLoader())) {
			...
			try {
				...
				clazz = ClassUtils.forName(className, WebAppInitializer.class.getClassLoader());
